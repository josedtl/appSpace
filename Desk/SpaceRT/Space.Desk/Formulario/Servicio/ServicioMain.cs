...
namespace Space.Desk.Formulario.Servicio
{
    public partial class ServicioMain : Form
    {
        ...
        public async void CargarTable()
        {
            try
            {
                ...
                dtServicio.Columns["Nombre"].MinimumWidth = 250;
                dtServicio.Columns["Nombre"].Width = 250;
                dtServicio.Columns["Nombre"].HeaderText = "Nombre";
                dtServicio.Columns["Descripcion"].MinimumWidth = 400;
                dtServicio.Columns["Descripcion"].Width = 400;
